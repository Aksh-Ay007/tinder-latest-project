      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="flex-grow">
          ...
          <div className="flex flex-wrap gap-3">
            {/* View Profile Button */}
            <Link 
             to="/userProfile" className="flex items-center text-gray-700 hover:text-purple-700 font-medium bg-gray-100 hover:bg-gray-200 py-2 px-4 rounded-lg transition duration-200">
