                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex space-x-3">
                        ...
                        {/* Accept Button */}
                        <button className="flex items-center text-white font-medium bg-green-500 hover:bg-green-600 py-2 px-4 rounded-lg transition duration-200 shadow-md">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        {/* Ignore Button */}
                        <button className="flex items-center text-white font-medium bg-red-500 hover:bg-red-600 py-2 px-4 rounded-lg transition duration-200 shadow-md">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
