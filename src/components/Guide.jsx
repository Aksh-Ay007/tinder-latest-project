  ...
  const steps = [
    {
      ...
      description:
        "Find your perfect match with our personalized matching algorithm. Let's set up your profile to attract the right person.",
    ...
    },
    {
      ...
      description:
        "First impressions matter! Profiles with quality photos receive 10x more attention.",
    ...
    },
    {
      ...
      description:
        "What makes you unique? Tell potential matches about your interests and hobbies.",
    ...
    },
    {
      ...
      description:
        "Your bio is your chance to shine. Be authentic and let your personality come through.",
    ...
    },
    {
      ...
      description:
        "You're all set to start your dating journey. Complete your profile now for the best experience.",
        ...
        >
          ...
          <div className="bg-gradient-to-r from-pink-50 to-purple-50 border-l-4 border-pink-400 p-4 mb-6 rounded-r-lg shadow-sm">
            <p className="text-sm text-pink-800">
              <span className="font-bold">💕 Dating Tip:</span>{" "}
          ...
          <div className="flex justify-between mt-8">
            ...
            {currentStep === steps.length - 1 ? (
              <div className="flex gap-4">
                ...
                <button
                  onClick={onSkip}
                  className="px-6 py-2.5 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded-lg shadow-md transform hover:scale-105 transition-all focus:outline-none focus:ring-2 focus:ring-gray-400"
                >
                  Do It Later
                </button>
              </div>
